...
### <a name="viewLocalization"></a> 2.2.1.Visualização das localidades 
...
<figure id="figViewActive">
	<img src="Figuras/view_active.png" alt="Visualização do ativo" title="Visualização do ativo" width="800">
